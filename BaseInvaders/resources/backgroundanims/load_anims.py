...
sprinkler_images = load_anim_images('./BaseInvaders/resources/backgroundanims/sprinkler/Sprinkler (<>).png', 1, 4, (500 / 1.7, 500 / 1.7))
smoke_images = load_anim_images('./BaseInvaders/resources/backgroundanims/smoke/Smoke (<>).png', 1, 4, (130 / 2, 227 / 2))
